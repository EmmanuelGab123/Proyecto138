...
//crear la variable score1 score1 = 0, score2 =0;
var score1 = 0
var score2 = 0
//crear la variable paddle1Y
var paddle1Y;
...
rightWristX = 0;
scoreRightWrist = 0;
//establecer la variable game_status como "";
game_status = "";

 function preload() {
  ball_touch_paddel = loadSound("ball_touch_paddel.wav");
  //establecer la variable missed como loadSound("missed.wav");
...
//establecer el tamaño de la varible video como 700,600
video.size(700, 600);
video.hide();
...
function gotPoses(results)
{
  if(results.length > 0)
  {
    ...
    //imprime en consola la variable scoreRightWrist
...
if(game_status == "start")
{
  ...
  if(scoreRightWrist > 0.2)
  {
    fill("red");
    stroke("red");
    //dibujar circulo en las coordenadas rightWristX, rightWristY, 30
